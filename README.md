...
# Run the code demo 1
- update the .env file in the project root directory with your credentials. (If it isn't there it will be created for you the first time you run `node server.js` the server. Next you can edit it. Save the file and restart the server)
